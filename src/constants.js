...
const fieldSetPopupCardForm = document.querySelector('.form__set-card');
...
const fieldSetPopupProfileForm = popupProfile.querySelector('.form__set-profile')
